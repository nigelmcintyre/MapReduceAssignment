...
public class MapReduce {
    ...
    public static void main(String[] args) {
        ...
        String wordString= "";
        File fileLocation = new File("C:/Users/Nigel/Desktop/extFiles");
...
//------------------------------------------------------------------------------------------------------------------------------
        ...
        // APPROACH #3: Distributed Part1_2
        {
...
//------------------------------------------------------------------------------------------------------------------------------
            int threads = 2;
            ExecutorService mapThreadPool = Executors.newFixedThreadPool(threads);
//------------------------------------------------------------------------------------------------------------------------------
            while(inputIter.hasNext()) {
                Map.Entry<String, String> entry = inputIter.next();
...
//------------------------------------------------------------------------------------------------------------------------------
           ...
           /* for(Thread t : mapCluster) {
            ...
            Iterator<Map.Entry<String, List<String>>> groupedIter = groupedItems.entrySet().iterator();
//------------------------------------------------------------------------------------------------------------------------------
            ExecutorService reduceThreadPool = Executors.newFixedThreadPool(threads);
//------------------------------------------------------------------------------------------------------------------------------
            while(groupedIter.hasNext()) {
                Map.Entry<String, List<String>> entry = groupedIter.next();
