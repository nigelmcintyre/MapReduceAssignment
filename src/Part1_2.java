...
//------------------------------------------------------------------------------------------------------------------------------
        ...
        System.out.printf("Time elapsed for approach 1 in nanoseconds: %d\n", timer);
//------------------------------------------------------------------------------------------------------------------------------
        System.out.println();
        ...
        System.out.printf("Time elapsed for approach 2 in nanoseconds: %d\n", timer);
//------------------------------------------------------------------------------------------------------------------------------
        System.out.println();
        ...
        // APPROACH #3: Distributed Part1_2
        {
            ...
            ExecutorService fixedPool = Executors.newFixedThreadPool(inputThreads);
